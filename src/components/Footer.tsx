      ...
      <div className="flex justify-between items-center">
        <div className="flex flex-col gap-4 w-1/4 text-left">
          <div className="flex gap-1 items-center">
            ...
            <span className="font-inter font-bold text-2xl text-font">
              Taskify
            </span>
          </div>
          ...
          <div className="flex gap-2 items-center">
            ...
            />
            <span className="font-inter font-medium text-sm text-dark leading-5">
              +7 (459) 322 23 33
            </span>
          </div>
        </div>
        <div className="flex gap-12 pb-6">
          <div className="flex flex-col gap-6 text-left">
            <p className="font-inter font-semibold text-lg text-dark">Team</p>
            <div className="flex flex-col gap-3">
              <span className="font-inter font-normal text-base text-primaryText">
                About Landio
              </span>
              <span className="font-inter font-normal text-base text-primaryText">
                Contact & Support
