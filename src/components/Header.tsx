  ...
  return (
    <header className="w-full py-6 px-5_5 flex justify-between items-center bg-white">
      <div className="flex items-center">
        ...
        <form
          action="search"
          className="w-[410px] ml-2 flex gap-4 justify-between items-center border-2 border-stroke rounded-3xl pr-5"
        >
          <input
            type="text"
          ...
          <FontAwesomeIcon
            ...
            className="text-dark5 w-3.5"
          />
        </form>
      </div>
      <div className="flex gap-4 items-center">
        <span className="font-inter font-medium text-sm text-primary leading-5">
          Login
        </span>
